...
<?php
	...
	{
		$name=$_GET['name'];
		$fnam = mysqli_fetch_assoc(mysqli_query($conn,"SELECT first_name FROM student_details WHERE username='$name'")); 
		$lnam = mysqli_fetch_assoc(mysqli_query($conn,"SELECT last_name FROM student_details WHERE username='$name'")); 
...
?>
<div class="art">
  <h1 style="color: yellowgreen">Company Information</h1>
</div>
<div class="tab">
